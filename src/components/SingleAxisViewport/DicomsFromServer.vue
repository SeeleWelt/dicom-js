                    ...
                    <el-table-column prop="file_name" label="文件名称" >
                        <template #default="scope">
                            <EditableCell
                                ...
                                @editableUpdate="(newname)=>handleApplicationFileNameUpdate(scope.row.file_name,newname)"
                            />
                            </template>
                    </el-table-column>
...
export default{
    ...
    methods:{
        handleApplicationFileNameUpdate(oldname,newname){
            axios.get("http://localhost:8000/applicationFile/updatename/",{
                params:{
                    oldname,
                    newname
                }
            ...
            .then(response=>{
                if(response.data.state==="success")
                {
                    ...
                    ElMessage.success("文件已经存在，请更换另外一个名字")
                }
            })
        },
